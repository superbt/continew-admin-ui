<template>
  <a-card class="general-card" title="我的项目">
    <template #extra>
      <a-dropdown>
        <a-link>更多 xbt</a-link>
        <template #content>
          <a-doption>
            <a-link href="http://www.shenbtw.online" target="_blank" rel="noopener">Gitee</a-link>
          </a-doption>
          <a-doption>
...
const list = [
  {
    alias: ' xbt1',
    name: 'continew-admin xbt',
    owner: 'continew-org xbt',
    desc: 'xbt 🔥Almost最佳后端规范🔥持续迭代优化的前后端分离中后台管理系统框架，开箱即用，持续提供舒适的开发体验。',
    logo: 'http://124.221.255.18:9000/btlog/3306e9e3a31f4a69b30ed8e43168f317.JPG',
    url: 'http://www.shenbtw.online',
    status: '迭代',
